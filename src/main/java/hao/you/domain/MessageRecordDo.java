...
public class MessageRecordDo {
    ...
    public MessageRecordDo(Integer id, String userId, String userName, Integer messageType, String content, Date createTime) {
        this.id = id;
        this.userId = userId;
    ...
    public static class MessageRecordBuilder{
        ...
        public MessageRecordBuilder userId(String userId) {
            this.userId = userId;
            return this;
        }
